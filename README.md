You can add items , delete items and search items in this web app . You can preview the screenshots for sample output in the browser using different port for json and react
